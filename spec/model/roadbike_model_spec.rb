 ...
 all_bike_info_hash_list << defy_adovanced_sl_0_bike_info_hash
  ...
  describe "serch_mach_bike(price_up, price_down,sex,color_param,road_bike_type,maker_id,frame_type)" do
    ...
    it "detetailが詳細条件のパラメーターが全てnilだった場合" do
      ...
      component_param = nil
      brake_type = nil
      expect(Roadbike.serch_mach_bike(price_up, price_down,sex,color_param,road_bike_type,maker_id,frame_type,component_param,brake_type).length).to eq 1
    end
  ...
  describe "self.serch_bike_result_and_size(bike_arry, user_size)" do
    ...
    color_param = "red"
      it "bike_arryがtrue,user_sizeが１６５だった場合" do
        ...
        component_param = nil
        brake_type = nil
        bike_arry = Roadbike.serch_mach_bike(price_up, price_down,sex,color_param,road_bike_type,maker_id,frame_type,component_param,brake_type)
        expect(Roadbike.serch_bike_result_and_size(bike_arry, user_size,).length).to eq 1
      end
