...
class MakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maker" do
    assert_difference('Maker.count') do
      post makers_url, params: { maker: { maker_name: @maker.maker_name, year: @maker.year } }
    end
  ...
  test "should update maker" do
    patch maker_url(@maker), params: { maker: { maker_name: @maker.maker_name, year: @maker.year } }
